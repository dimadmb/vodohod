...
class AddUserCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('is-super-admin', null, InputOption::VALUE_NONE, 'If set, the user is created as an super-administrator')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $isSuperAdmin = $input->getOption('is-super-admin');
        ...
        $user->setEmail($email);
		$roles = $isSuperAdmin ? 'ROLE_SUPER_ADMIN' : ($isAdmin ? 'ROLE_ADMIN' : 'ROLE_USER');
